...
// allowed characters (space or hyphen) and not a combination of both (e.g. +359 2-111 111 has mixed delimiters, it is invalid).
...
function matchPhoneNumber(input) {
  console.log(
    input[0].match(/(?<=^|\s)\+359([ -])2\1\d{3}\1\d{4}\b/g).join(", ")
  );
}
